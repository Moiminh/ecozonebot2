...
# [SỬA] Đảm bảo chỉ import các hàm cần thiết, không import thừa
...
class CrimeCommandCog(commands.Cog, name="Crime Command"):
    ...
    async def crime(self, ctx: commands.Context):
        ...
        try:
            # [SỬA] Sử dụng cache từ bot, đây là phiên bản đã đúng
            ...
            await ctx.send(f"Tổng Ví Local hiện tại: **{final_total_balance:,}** {ICON_MONEY_BAG}", delete_after=10)
