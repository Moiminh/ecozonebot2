...
# --- BẮT ĐẦU BẰNG VIỆC GIỮ CHO TERMUX "THỨC" ---
echo "[+] Đang kích hoạt Wakelock để giữ kết nối ổn định..."
termux-wake-lock

# Hàm cleanup để dừng bot và giải phóng wakelock
cleanup() {
    ...
    # Giải phóng Wakelock khi script kết thúc
    echo "[+] Đang giải phóng Wakelock..."
    termux-wake-unlock
